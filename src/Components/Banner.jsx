...
const Banner = () => {
    return (
        <div id='top' className='lg:flex lg:h-[500px] flex-row-reverse  mt-[80px]'>
           ...
           className='rounded-full w-80 h-80 border-4 p-2 bg-white  border-red-200 scale-125' src={riyal} alt="" />
            </div>
            <div  className='lg:w-2/3 banner-bg py-6 rounded-2xl clip-path-custom mt-8 flex justify-center items-center'>
               <div className='w-3/4 '>
               <motion.h1 
               ...
               className=' text-4xl  font-bold text-center font-RubikVinyl tracking-widest uppercase'>Front-end <p className='ml-10'> developer</p></motion.h1>
                <p className='text-center px-5 text-gray-500 text-xl'> 
                                    <Typewriter
                                     typeSpeed={20}
                                      deleteSpeed={20}
                                       cursorStyle
